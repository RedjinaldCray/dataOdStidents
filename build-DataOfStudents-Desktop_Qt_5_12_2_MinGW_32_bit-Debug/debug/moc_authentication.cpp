...
#include "../../DataOfStudents/authentication.h"
...
QT_MOC_LITERAL(1, 15, 11), // "verify_true"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7) // "setData"

    },
    "Authentication\0verify_true\0\0setData"
};
...
void Authentication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Authentication::verify_true)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Authentication::verify_true()
{
